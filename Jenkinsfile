...
//             }
        ...
        stage('update'){
            steps{
                ...
                sh "docker run --name shinigami-cicd1 -p 8080:8080 --network shinigami1 -d wiryaimd/shinigami-cicd:${env.BUILD_NUMBER} --server.port=8080 --spring.datasource.url=jdbc:mysql://27b3e296e514:3306/db_shinigami_8ce117 --spring.datasource.password=8ce117da --logging.file.name=logs/shinigami_app.log --midtrans.secretkey=Mid-server-M0YlsNpDY_0fTcDjbrXuzu58 --spring.datasource.hikari.minimum-idle=20 --spring.datasource.hikari.maximum-pool-size=25 --spring.datasource.hikari.idle-timeout=200000 --spring.datasource.hikari.connection-timeout=250000 --spring.jpa.open-in-view=false"
